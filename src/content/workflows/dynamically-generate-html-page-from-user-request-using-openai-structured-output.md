...
steps:
  ...
  - stepNumber: 2
    title: "Open AI - Using Structured Output"
    description: "Processes and automates operations via the Http Request integration."
    tool: "Http Request"
  - stepNumber: 3
    title: "Format the HTML result"
...
Optimize your tech stack and automate workflows between Respond To Webhook, Http Request, Html, Sticky Note, Webhook natively. 
